    ...
    return (
        <>
            ...
            <header className="flex justify-between items-center py-7 px-4 text-lg bg-gray-900 text-white sticky top-0 right-0 left-0">
                ...
                <div className="text-2xl ml-6 group hover:text-cyan-500 transition duration-200 ease-in-out">
                    <a href="/" className="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">Pietro Ponte</a>
                </div>

                <nav className="justify-between ">
                    <a href="#about" className="group hover:text-cyan-500 transition duration-200 ease-in-out">
                    ...
                    <a href="#skills" className="ml-8 group hover:text-cyan-500 transition duration-200 ease-in-out">
                    ...
                    <a href="#projects" className="ml-8 group  hover:text-cyan-500 transition duration-200 ease-in-out">
                    ...
                    <a href="#contacts" className="ml-8 mr-6 group  hover:text-cyan-500 transition duration-200 ease-in-out">
