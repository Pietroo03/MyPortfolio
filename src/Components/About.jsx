                        ...
                        <li className='pb-10 md:pb-13 flex items-center'>
                            ...
                            <div className='pl-4'>
                                <span className='font-bold text-indigo-400 inline-block group transition-transform duration-500 ease-in-out hover:scale-105'>
                                    <Link to='projects' smooth={true} duration={1200} offset={offset} className="cursor-pointer bg-left-bottom bg-gradient-to-r from-indigo-400 to-indigo-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">My Projects:</Link>
                                </span>
