            ...
            <section id="skills" className="py-20 md:pb-80 md:pt-50 lg:pt-30  px-2 md:px-8 lg:px-10 bg-gray-700">
                <div className='container mx-auto'>
                    ...
                    <motion.div
                        ...
                        <div>Let's go over the skills I have learned during the <span className='text-cyan-500'><strong>Boolean</strong></span>  course and beyond.</div>
                        <br />
                        <div>The goal is to continuously add more skills to this section.</div>
                    </motion.div>

                    {/* Grid with skills buttons, no click effects */}
                    <motion.div
                        initial={{ opacity: 0, y: 200 }}
                        ...
                        {skills.map((skill, index) => (
                            <motion.div
                                initial={{ opacity: 0, y: 200 }}
                                animate={controls}
                                transition={{ duration: 1.4, delay: index * 0.2, ease: "easeOut" }}
                                key={index}
